...
task main()
{
	...
	const int T_basket_L[CRATE_NUM] = {1000, 400, 1200, 500};
	const int T_basket_R[CRATE_NUM] = {900, 500, 1100, 500};
	const int T_offset_L[CRATE_NUM] = {300, 350, 150, 100};
