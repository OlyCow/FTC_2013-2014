// This header contains functionality for the HiTechnic Sensor Multiplexer.
...
void HTSMUXsensorTypeToString(HTSMUXSensorType muxsensor, string &sensorName) {
	switch(muxsensor) {
	case HTSMUXAnalogue:	sensorName = "Analog";		break;
	case HTSMUXLegoUS:		sensorName = "Ultrasonic";	break;
	case HTSMUXCompass:		sensorName = "Compass";		break;
	case HTSMUXColor:		sensorName = "Light";		break;
	case HTSMUXColorNew:	sensorName = "Color";		break;
	case HTSMUXAccel:		sensorName = "Accel";		break;
	case HTSMUXIRSeeker:	sensorName = "IR";			break;
	case HTSMUXProto:		sensorName = "Proto Board";	break;
	case HTSMUXIRSeekerNew:	sensorName = "IR V2";		break;
