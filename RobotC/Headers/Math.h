...
float Math_Arccot(float input, AngleUnit units=UNIT_DEG);
float Math_Arcsec(float input, AngleUnit units=UNIT_DEG);
float Math_Arccsc(float input, AngleUnit units=UNIT_DEG);
float Math_Arcsin2(float x, float y, AngleUnit units=UNIT_DEG); //Is this possible?
float Math_Arccos2(float x, float y, AngleUnit units=UNIT_DEG); //Is this possible?
float Math_Arctan2(float x, float y, AngleUnit units=UNIT_DEG);
float Math_Arccot2(float x, float y, AngleUnit units=UNIT_DEG);
float Math_Arcsec2(float x, float y, AngleUnit units=UNIT_DEG); //Is this possible?
float Math_Arccsc2(float x, float y, AngleUnit units=UNIT_DEG); //Is this possible?
